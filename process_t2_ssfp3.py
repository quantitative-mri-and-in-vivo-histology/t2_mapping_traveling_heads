...
def main():
        ...
        if sessions:  # Only add subjects with existing sessions
            for session in sessions:
                ...
                for run in runs:
                    ...
                    t1w_a12_file = layout.get(subject=subject,
                                              session=session,
                                              suffix="T1w",
                    ...
                    if len(t1w_a12_file) == 1 and len(t1w_a13_file) == 0:
                        t1w_a13_file = t1w_a12_file
    ...
    # set up worfklow
    wf = Workflow(name="t2_ssfp3_workflow",
