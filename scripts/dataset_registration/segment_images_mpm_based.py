...
def main():
    ...
    # # merge atropos inputs
    # merge_atropos_inputs = pe.Node(Merge(3), name="merge_atropos_inputs")
    # wf.connect(input_node, "t1_map_file",
    #            merge_atropos_inputs, "in1")
    # wf.connect(input_node, "mt_sat_map_file",
    #            merge_atropos_inputs, "in2")
    # wf.connect(input_node, "pd_map_file",
    #            merge_atropos_inputs, "in3")
    ...
    # wf.connect(merge_atropos_inputs, "out", atropos, "intensity_images")
    wf.connect(input_node, "mt_sat_map_file", atropos, "intensity_images")
